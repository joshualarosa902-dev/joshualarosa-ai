...
const DATA = {
  ...
  total: { n: "92.3K", note: "across Instagram & TikTok — plus 8.3K newsletter subscribers, and a far larger audience who watch without ever following." },
  platforms: [
    {
      name: "Instagram", tag: "The engine", handle: "@joshualarosa.ai", href: "https://www.instagram.com/joshualarosa.ai",
      stats: [{ n: "52.9K", l: "Followers" }, { n: "1.2M", l: "Views / 30 days" }, { n: "302K", l: "Top reel · 30 days" }, { n: "8.6%", l: "Engagement · top 25%" }],
      story: "1.2 million views in the last 30 days on 52.9K followers — roughly 23× my following — with back-to-back breakouts at 302K and 284K views. An 8.6% engagement rate puts me in the top 25% of creators my size. Most don't come close.",
    },
    {
        ...
        <section className="wrap section">
          <div style={{ borderTop: "1px solid var(--c-line)", borderBottom: "1px solid var(--c-line)", padding: "var(--s-7) 0", display: "flex", gap: "var(--s-7)", alignItems: "center", flexWrap: "wrap" }}>
            <div style={{ flex: "none" }}>
              ...
              <div style={{ fontFamily: "var(--font-display)", fontWeight: 600, fontSize: "clamp(52px,12vw,120px)", letterSpacing: "-0.04em", lineHeight: 0.85, color: "var(--c-ink)" }}>92.3K</div>
            </div>
